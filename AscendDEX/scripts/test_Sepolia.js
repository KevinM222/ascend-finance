...
async function main() {
    ...
    // Test 1: Buy with ETH (buyWithPol)
    ...
    // Test 3: Set new price (setPrice)
    console.log("\nTest 3: Setting new price to 100 ASC/ETH, 100 ASC/USDC...");
    await sale.setPrice(100, 100);
    ...
    console.log("\nTest 4: Sending 0.11 ETH to treasury and staking...");
    await deployer.sendTransaction({ to: treasuryAddress, value: hre.ethers.utils.parseEther("0.11") });
    ...
    // Test 5: Wrap ETH to WPOL (POL mock)
    ...
    // Test 6: Withdraw USDC from sale (admin)
    ...
    // Test 7: Withdraw ETH from sale (admin)
    ...
    // Test 8: Withdraw ASC from sale (admin)
    ...
    // Test 9: Withdraw WPOL from treasury (admin)
